...
var score=0;
 		...
 		$.getJSON('/game/activity.json', function(data) {
...
for (var i = 0; i < cookies.length; i++)
  eraseCookie(cookies[i].split("=")[0]);}
		$(stage).append('<div class="questionText">You have finished the quiz!<br><br>Total questions: '+numberOfQuestions+'<br>Correct answers: '+score+'</div> <a href = leaderboard.html>Please enter your name in the leaderboard! Score: '+score+'</a>');
